...
public class VolcengineAsrClient extends WebSocketClient {
    ...
    public static VolcengineAsrClient build() throws URISyntaxException {
        URI uri = new URI(URL);
        return new VolcengineAsrClient(uri);
    }

    // TODO 接受一个 listener 监听消息, onOpen, onMessage, onError, onComplete
    private VolcengineAsrClient(URI uri) {
        super(uri);
    }
